...
@router.get("/live/smoke-test/alert-status")
@router.head("/live/smoke-test/alert-status")
async def smoke_test_alert_status():
    return {"status": "ok"}


# ============================================================================
# DEBUG: AUTOGRADER VERIFICATION ENDPOINTS
# ============================================================================

@router.get("/debug/pending-picks")
async def debug_pending_picks():
    ...
    try:
        ...
        return {
            ...
            "yesterday_total": len(yesterday_picks),
...
@router.post("/debug/run-autograde")

...
# ============================================================
# TEAM OFFENSIVE RATINGS (for Monte Carlo simulation)
# ============================================================
# Format: {team: {"off_rating": avg_points, "off_rating_std": std_dev}}
# Based on 2024-25 season data

NBA_OFFENSIVE_RATINGS = {
    "Boston Celtics": {"off_rating": 122.5, "off_rating_std": 11.2},
    "Oklahoma City Thunder": {"off_rating": 121.3, "off_rating_std": 10.8},
    "Cleveland Cavaliers": {"off_rating": 120.8, "off_rating_std": 10.5},
    "Indiana Pacers": {"off_rating": 119.5, "off_rating_std": 12.1},
    "Milwaukee Bucks": {"off_rating": 118.2, "off_rating_std": 11.5},
    "Dallas Mavericks": {"off_rating": 117.8, "off_rating_std": 11.0},
    "Denver Nuggets": {"off_rating": 117.5, "off_rating_std": 10.3},
    "Phoenix Suns": {"off_rating": 117.2, "off_rating_std": 11.8},
    "Sacramento Kings": {"off_rating": 116.8, "off_rating_std": 12.0},
    "New York Knicks": {"off_rating": 116.5, "off_rating_std": 10.8},
    "Los Angeles Clippers": {"off_rating": 115.8, "off_rating_std": 10.5},
    "Miami Heat": {"off_rating": 115.5, "off_rating_std": 11.2},
    "Golden State Warriors": {"off_rating": 115.2, "off_rating_std": 11.5},
    "Minnesota Timberwolves": {"off_rating": 114.8, "off_rating_std": 10.2},
    "Los Angeles Lakers": {"off_rating": 114.5, "off_rating_std": 11.0},
    "Philadelphia 76ers": {"off_rating": 114.2, "off_rating_std": 12.5},
    "Atlanta Hawks": {"off_rating": 113.8, "off_rating_std": 11.8},
    "New Orleans Pelicans": {"off_rating": 113.5, "off_rating_std": 10.8},
    "Houston Rockets": {"off_rating": 113.2, "off_rating_std": 10.5},
    "Orlando Magic": {"off_rating": 112.8, "off_rating_std": 9.8},
    "Memphis Grizzlies": {"off_rating": 112.5, "off_rating_std": 11.5},
    "Chicago Bulls": {"off_rating": 112.2, "off_rating_std": 11.0},
    "Brooklyn Nets": {"off_rating": 111.8, "off_rating_std": 12.0},
    "San Antonio Spurs": {"off_rating": 111.5, "off_rating_std": 12.5},
    "Toronto Raptors": {"off_rating": 111.2, "off_rating_std": 11.8},
    "Utah Jazz": {"off_rating": 110.8, "off_rating_std": 12.2},
    "Portland Trail Blazers": {"off_rating": 110.5, "off_rating_std": 12.5},
    "Charlotte Hornets": {"off_rating": 110.2, "off_rating_std": 12.8},
    "Detroit Pistons": {"off_rating": 109.8, "off_rating_std": 12.0},
    "Washington Wizards": {"off_rating": 109.5, "off_rating_std": 13.0},
}

NFL_OFFENSIVE_RATINGS = {
    "Miami Dolphins": {"off_rating": 28.5, "off_rating_std": 8.5},
    "San Francisco 49ers": {"off_rating": 27.8, "off_rating_std": 7.8},
    "Dallas Cowboys": {"off_rating": 27.5, "off_rating_std": 8.2},
    "Buffalo Bills": {"off_rating": 27.2, "off_rating_std": 7.5},
    "Philadelphia Eagles": {"off_rating": 26.8, "off_rating_std": 8.0},
    "Detroit Lions": {"off_rating": 26.5, "off_rating_std": 7.8},
    "Kansas City Chiefs": {"off_rating": 26.2, "off_rating_std": 7.2},
    "Cincinnati Bengals": {"off_rating": 25.8, "off_rating_std": 8.5},
    "Jacksonville Jaguars": {"off_rating": 25.5, "off_rating_std": 8.8},
    "Los Angeles Chargers": {"off_rating": 25.2, "off_rating_std": 8.0},
    "Green Bay Packers": {"off_rating": 24.8, "off_rating_std": 8.2},
    "Seattle Seahawks": {"off_rating": 24.5, "off_rating_std": 8.5},
    "Minnesota Vikings": {"off_rating": 24.2, "off_rating_std": 7.8},
    "Las Vegas Raiders": {"off_rating": 23.8, "off_rating_std": 8.8},
    "Los Angeles Rams": {"off_rating": 23.5, "off_rating_std": 8.5},
    "Houston Texans": {"off_rating": 23.2, "off_rating_std": 7.5},
    "Baltimore Ravens": {"off_rating": 23.0, "off_rating_std": 7.2},
    "Pittsburgh Steelers": {"off_rating": 22.8, "off_rating_std": 7.0},
    "Tampa Bay Buccaneers": {"off_rating": 22.5, "off_rating_std": 8.2},
    "Arizona Cardinals": {"off_rating": 22.2, "off_rating_std": 8.8},
    "Indianapolis Colts": {"off_rating": 22.0, "off_rating_std": 8.5},
    "Atlanta Falcons": {"off_rating": 21.8, "off_rating_std": 8.0},
    "Chicago Bears": {"off_rating": 21.5, "off_rating_std": 7.8},
    "Denver Broncos": {"off_rating": 21.2, "off_rating_std": 7.5},
    "Cleveland Browns": {"off_rating": 21.0, "off_rating_std": 8.2},
    "New Orleans Saints": {"off_rating": 20.8, "off_rating_std": 8.5},
    "Tennessee Titans": {"off_rating": 20.5, "off_rating_std": 7.8},
    "New York Giants": {"off_rating": 20.2, "off_rating_std": 8.8},
    "New England Patriots": {"off_rating": 20.0, "off_rating_std": 7.5},
    "New York Jets": {"off_rating": 19.8, "off_rating_std": 8.0},
    "Washington Commanders": {"off_rating": 19.5, "off_rating_std": 8.5},
    "Carolina Panthers": {"off_rating": 19.2, "off_rating_std": 9.0},
}

NHL_OFFENSIVE_RATINGS = {
    "Florida Panthers": {"off_rating": 3.65, "off_rating_std": 1.45},
    "Colorado Avalanche": {"off_rating": 3.58, "off_rating_std": 1.52},
    "Edmonton Oilers": {"off_rating": 3.55, "off_rating_std": 1.48},
    "Vegas Golden Knights": {"off_rating": 3.48, "off_rating_std": 1.38},
    "Toronto Maple Leafs": {"off_rating": 3.45, "off_rating_std": 1.42},
    "Dallas Stars": {"off_rating": 3.38, "off_rating_std": 1.35},
    "New York Rangers": {"off_rating": 3.35, "off_rating_std": 1.32},
    "Carolina Hurricanes": {"off_rating": 3.32, "off_rating_std": 1.28},
    "Tampa Bay Lightning": {"off_rating": 3.28, "off_rating_std": 1.38},
    "Boston Bruins": {"off_rating": 3.25, "off_rating_std": 1.25},
    "New Jersey Devils": {"off_rating": 3.22, "off_rating_std": 1.35},
    "Winnipeg Jets": {"off_rating": 3.18, "off_rating_std": 1.42},
    "Los Angeles Kings": {"off_rating": 3.15, "off_rating_std": 1.28},
    "Vancouver Canucks": {"off_rating": 3.12, "off_rating_std": 1.38},
    "Nashville Predators": {"off_rating": 3.08, "off_rating_std": 1.25},
    "Pittsburgh Penguins": {"off_rating": 3.05, "off_rating_std": 1.45},
    "Detroit Red Wings": {"off_rating": 3.02, "off_rating_std": 1.35},
    "Ottawa Senators": {"off_rating": 2.98, "off_rating_std": 1.42},
    "New York Islanders": {"off_rating": 2.95, "off_rating_std": 1.22},
    "Minnesota Wild": {"off_rating": 2.92, "off_rating_std": 1.28},
    "Seattle Kraken": {"off_rating": 2.88, "off_rating_std": 1.35},
    "Calgary Flames": {"off_rating": 2.85, "off_rating_std": 1.32},
    "St. Louis Blues": {"off_rating": 2.82, "off_rating_std": 1.38},
    "Philadelphia Flyers": {"off_rating": 2.78, "off_rating_std": 1.42},
    "Buffalo Sabres": {"off_rating": 2.75, "off_rating_std": 1.48},
    "Montreal Canadiens": {"off_rating": 2.72, "off_rating_std": 1.52},
    "Arizona Coyotes": {"off_rating": 2.68, "off_rating_std": 1.45},
    "Columbus Blue Jackets": {"off_rating": 2.65, "off_rating_std": 1.55},
    "Anaheim Ducks": {"off_rating": 2.62, "off_rating_std": 1.48},
    "Chicago Blackhawks": {"off_rating": 2.58, "off_rating_std": 1.58},
    "San Jose Sharks": {"off_rating": 2.55, "off_rating_std": 1.52},
}

MLB_OFFENSIVE_RATINGS = {
    "Los Angeles Dodgers": {"off_rating": 5.45, "off_rating_std": 2.85},
    "Atlanta Braves": {"off_rating": 5.35, "off_rating_std": 2.78},
    "Texas Rangers": {"off_rating": 5.25, "off_rating_std": 2.92},
    "Tampa Bay Rays": {"off_rating": 5.15, "off_rating_std": 2.65},
    "Baltimore Orioles": {"off_rating": 5.08, "off_rating_std": 2.72},
    "Philadelphia Phillies": {"off_rating": 5.02, "off_rating_std": 2.88},
    "Houston Astros": {"off_rating": 4.95, "off_rating_std": 2.68},
    "Minnesota Twins": {"off_rating": 4.88, "off_rating_std": 2.82},
    "Arizona Diamondbacks": {"off_rating": 4.82, "off_rating_std": 2.92},
    "Milwaukee Brewers": {"off_rating": 4.75, "off_rating_std": 2.65},
    "San Diego Padres": {"off_rating": 4.68, "off_rating_std": 2.78},
    "Seattle Mariners": {"off_rating": 4.62, "off_rating_std": 2.58},
    "Toronto Blue Jays": {"off_rating": 4.55, "off_rating_std": 2.85},
    "Boston Red Sox": {"off_rating": 4.48, "off_rating_std": 2.92},
    "New York Yankees": {"off_rating": 4.42, "off_rating_std": 2.75},
    "Chicago Cubs": {"off_rating": 4.35, "off_rating_std": 2.68},
    "Los Angeles Angels": {"off_rating": 4.28, "off_rating_std": 2.82},
    "Cincinnati Reds": {"off_rating": 4.22, "off_rating_std": 2.95},
    "San Francisco Giants": {"off_rating": 4.15, "off_rating_std": 2.72},
    "Cleveland Guardians": {"off_rating": 4.08, "off_rating_std": 2.55},
    "Detroit Tigers": {"off_rating": 4.02, "off_rating_std": 2.78},
    "New York Mets": {"off_rating": 3.95, "off_rating_std": 2.85},
    "Pittsburgh Pirates": {"off_rating": 3.88, "off_rating_std": 2.72},
    "St. Louis Cardinals": {"off_rating": 3.82, "off_rating_std": 2.68},
    "Kansas City Royals": {"off_rating": 3.75, "off_rating_std": 2.82},
    "Miami Marlins": {"off_rating": 3.68, "off_rating_std": 2.55},
    "Washington Nationals": {"off_rating": 3.62, "off_rating_std": 2.88},
    "Chicago White Sox": {"off_rating": 3.55, "off_rating_std": 2.95},
    "Colorado Rockies": {"off_rating": 3.48, "off_rating_std": 3.15},
    "Oakland Athletics": {"off_rating": 3.42, "off_rating_std": 2.78},
}

NCAAB_OFFENSIVE_RATINGS = {
    "Gonzaga": {"off_rating": 88.5, "off_rating_std": 12.5},
    "Duke": {"off_rating": 87.8, "off_rating_std": 11.8},
    "Kansas": {"off_rating": 87.2, "off_rating_std": 11.5},
    "Kentucky": {"off_rating": 86.5, "off_rating_std": 12.2},
    "North Carolina": {"off_rating": 86.0, "off_rating_std": 11.8},
    "Auburn": {"off_rating": 85.5, "off_rating_std": 10.8},
    "Houston": {"off_rating": 85.0, "off_rating_std": 10.2},
    "Tennessee": {"off_rating": 84.5, "off_rating_std": 10.5},
    "Arizona": {"off_rating": 84.0, "off_rating_std": 11.5},
    "Purdue": {"off_rating": 83.5, "off_rating_std": 10.8},
    "UConn": {"off_rating": 83.0, "off_rating_std": 11.2},
    "Alabama": {"off_rating": 82.5, "off_rating_std": 12.5},
    "Baylor": {"off_rating": 82.0, "off_rating_std": 11.0},
    "Creighton": {"off_rating": 81.5, "off_rating_std": 10.8},
    "Marquette": {"off_rating": 81.0, "off_rating_std": 11.5},
    "Texas": {"off_rating": 80.5, "off_rating_std": 11.2},
    "UCLA": {"off_rating": 80.0, "off_rating_std": 10.5},
    "Iowa State": {"off_rating": 79.5, "off_rating_std": 9.8},
    "Florida": {"off_rating": 79.0, "off_rating_std": 11.8},
    "Illinois": {"off_rating": 78.5, "off_rating_std": 11.5},
}
...
class MonteCarloService:
    """
    Monte Carlo simulation service for game outcome predictions.
    Uses team offensive ratings to simulate thousands of game outcomes.
    """

    RATINGS_DATA = {
        "NBA": NBA_OFFENSIVE_RATINGS,
        "NFL": NFL_OFFENSIVE_RATINGS,
        "NHL": NHL_OFFENSIVE_RATINGS,
        "MLB": MLB_OFFENSIVE_RATINGS,
        "NCAAB": NCAAB_OFFENSIVE_RATINGS,
    }

    # Default ratings for teams not in database
    DEFAULT_RATINGS = {
        "NBA": {"off_rating": 112.0, "off_rating_std": 11.0},
        "NFL": {"off_rating": 22.0, "off_rating_std": 8.0},
        "NHL": {"off_rating": 3.0, "off_rating_std": 1.4},
        "MLB": {"off_rating": 4.2, "off_rating_std": 2.7},
        "NCAAB": {"off_rating": 75.0, "off_rating_std": 12.0},
    }

    @classmethod
    def get_team_ratings(cls, sport: str, team: str) -> Dict[str, float]:
        """Get offensive ratings for a team."""
        sport = sport.upper()
        team = standardize_team(team, sport)

        ratings_db = cls.RATINGS_DATA.get(sport, {})
        if team in ratings_db:
            return ratings_db[team]

        # Try partial match
        for db_team, ratings in ratings_db.items():
            if team.lower() in db_team.lower() or db_team.lower() in team.lower():
                return ratings

        return cls.DEFAULT_RATINGS.get(sport, {"off_rating": 100, "off_rating_std": 10})
    ...
    def simulate_game(
        ...
        Returns:
            Dict with win probabilities, score distribution, and confidence bands
        """
        sport = sport.upper()

        home_stats = cls.get_team_ratings(sport, home_team)
        away_stats = cls.get_team_ratings(sport, away_team)

        # Sport-specific home advantage
        if home_advantage is None:
            home_advantages = {
                "NBA": 3.0,    # ~3 points home advantage
                "NFL": 2.5,    # ~2.5 points home advantage
                "NHL": 0.15,   # ~0.15 goals home advantage
                "MLB": 0.15,   # ~0.15 runs home advantage
                "NCAAB": 3.5,  # ~3.5 points home advantage (loud crowds)
            }
            home_advantage = home_advantages.get(sport, 2.0)
        ...
        for _ in range(num_simulations):
            ...
            home_score = np.random.normal(
                home_stats["off_rating"] + home_advantage,
                home_stats["off_rating_std"]
            )

            # Simulate away team score
            away_score = np.random.normal(
                away_stats["off_rating"],
                away_stats["off_rating_std"]
            )
        ...
        avg_total = avg_home_score + avg_away_score

        # Confidence bands (68% and 95%)
        margin_p16 = np.percentile(margins, 16)
        margin_p84 = np.percentile(margins, 84)
        margin_p2_5 = np.percentile(margins, 2.5)
        margin_p97_5 = np.percentile(margins, 97.5)

        total_scores = [h + a for h, a in zip(home_scores, away_scores)]
        total_p16 = np.percentile(total_scores, 16)
        total_p84 = np.percentile(total_scores, 84)
        ...
        return {
            ...
            "tie_pct": round(ties / num_simulations, 4),
            "predicted_margin": round(avg_margin, 2),
            "margin_std": round(std_margin, 2),
            "margin_68_band": (round(margin_p16, 2), round(margin_p84, 2)),
            "margin_95_band": (round(margin_p2_5, 2), round(margin_p97_5, 2)),
            "predicted_home_score": round(avg_home_score, 1),
            "predicted_away_score": round(avg_away_score, 1),
            "predicted_total": round(avg_total, 1),
            "total_68_band": (round(total_p16, 1), round(total_p84, 1)),
            "confidence": cls._calculate_confidence(home_win_pct, away_win_pct),
            "edge_vs_spread": None,  # Will be filled when spread is provided
        }

    @classmethod
    def _calculate_confidence(cls, home_pct: float, away_pct: float) -> str:
        """Calculate confidence level from win probabilities."""
        stronger_pct = max(home_pct, away_pct)
        if stronger_pct >= 0.70:
            return "HIGH"
        elif stronger_pct >= 0.58:
            return "MEDIUM"
        else:
            return "LOW"
    ...
    def evaluate_spread(
        ...
        """
        Evaluate a spread bet using Monte Carlo simulation.

        Args:
            spread: The spread (negative = home favored, positive = away favored)

        Returns:
            Dict with cover probabilities and edge analysis
        """
        sim_result = cls.simulate_game(sport, home_team, away_team, num_simulations)

        # Simulate cover probability
        home_stats = cls.get_team_ratings(sport, home_team)
        away_stats = cls.get_team_ratings(sport, away_team)

        home_advantages = {"NBA": 3.0, "NFL": 2.5, "NHL": 0.15, "MLB": 0.15, "NCAAB": 3.5}
        home_adv = home_advantages.get(sport.upper(), 2.0)
        ...
        for _ in range(num_simulations):
            home_score = np.random.normal(
                home_stats["off_rating"] + home_adv,
                home_stats["off_rating_std"]
            )
            away_score = np.random.normal(
                away_stats["off_rating"],
            ...
            # Margin with spread applied
            # If spread is -5.5 (home favored by 5.5), home covers if margin > 5.5
            margin = home_score - away_score
            adjusted_margin = margin + spread  # spread is negative for home favorite
        ...
        home_cover_pct = home_covers / num_simulations
        away_cover_pct = away_covers / num_simulations

        # Calculate edge (difference from implied 50%)
        edge = abs(home_cover_pct - 0.5) * 100

        # Determine recommendation
        if home_cover_pct > 0.55:
            recommendation = f"HOME covers {spread:+.1f}"
            side = "HOME"
        elif away_cover_pct > 0.55:
            recommendation = f"AWAY covers {-spread:+.1f}"
            side = "AWAY"
        else:
        ...
        return {
            "spread": spread,
            "home_cover_pct": round(home_cover_pct, 4),
            "away_cover_pct": round(away_cover_pct, 4),
            "push_pct": round(pushes / num_simulations, 4),
            "edge_pct": round(edge, 2),
            "recommendation": recommendation,
            "side": side,
            "predicted_margin": sim_result["predicted_margin"],
            "margin_vs_spread": round(sim_result["predicted_margin"] - abs(spread), 2),
    ...
    def evaluate_total(
        ...
        """
        Evaluate an over/under bet using Monte Carlo simulation.

        Returns:
            Dict with over/under probabilities and edge analysis
        """
        home_stats = cls.get_team_ratings(sport, home_team)
        away_stats = cls.get_team_ratings(sport, away_team)
        ...
        for _ in range(num_simulations):
            ...
            if game_total > total_line:
                overs += 1
            elif game_total < total_line:
                unders += 1
            else:
                pushes += 1

        over_pct = overs / num_simulations
        under_pct = unders / num_simulations

        predicted_total = np.mean(totals)
        edge = abs(over_pct - 0.5) * 100
        ...
        return {
            ...
            "total_vs_line": round(predicted_total - total_line, 1),
            "confidence": "HIGH" if edge > 8 else "MEDIUM" if edge > 4 else "LOW",
        }

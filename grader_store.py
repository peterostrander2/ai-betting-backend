...
Storage: Railway volume at /app/grader_data/predictions.json
...
STORAGE_DIR = os.getenv("GRADER_DATA_DIR", "/app/grader_data")
...
def ensure_storage_writable():
    ...
    try:
        ...
        logger.info("GRADER_STORE: storage_path=%s exists=%s writable=True bytes=%d",
                    PREDICTIONS_FILE, exists, size_bytes)

        return True

    except Exception as e:
        logger.error("GRADER_STORE: Storage not writable at %s: %s", STORAGE_DIR, e)
